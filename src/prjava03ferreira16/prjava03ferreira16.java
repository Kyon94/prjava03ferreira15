...
public class prjava03ferreira16 extends Frame 
   ...
   public prjava03ferreira16 () { 
      ...
      setTitle("nova finestra prjava03ferreira16");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new prjava03ferreira16();  // Let the construct do the job 
   } 
